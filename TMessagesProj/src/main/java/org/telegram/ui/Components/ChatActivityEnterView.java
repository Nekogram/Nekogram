...
//                    list.add(2);
    ...
    private void sendPhoto(String mime, Uri uri, boolean notify, int scheduleDate) {
        ...
        if (mime.equalsIgnoreCase("image/gif")) {
            SendMessagesHelper.prepareSendingDocument(accountInstance, null, null, uri, null, "image/gif", dialog_id, replyingMessageObject, getThreadMessage(), null, replyingQuote, null, notify, 0, mime, parentFragment != null ? parentFragment.quickReplyShortcut : null, parentFragment != null ? parentFragment.getQuickReplyId() : 0);
        } else {
