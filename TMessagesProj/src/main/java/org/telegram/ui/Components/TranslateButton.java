...
public class TranslateButton extends FrameLayout {
    ...
    protected void onMenuClick() {
        ...
        if (currentTranslateTo != null) {
            String displayName = "app".equals(currentTranslateTo) ? LocaleController.getString(R.string.TranslationTargetApp) : TranslateAlert2.capitalFirst(TranslateAlert2.languageName(currentTranslateTo));
            if (displayName != null) {
