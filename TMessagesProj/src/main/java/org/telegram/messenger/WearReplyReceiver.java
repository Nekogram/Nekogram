...
public class WearReplyReceiver extends BroadcastReceiver {
    ...
    private void sendMessage(AccountInstance accountInstance, CharSequence text, ArrayList<Uri> images, long dialog_id, long topicId, int max_id) {
        ...
        if (images.isEmpty()) {
            ...
            SendMessagesHelper.prepareSendingMedia(accountInstance, infos, dialog_id, replyToMsgId, replyToTopMsgId, null, null, false, images.size() > 1, null, true, 0, 0, false, null, null, 0, 0, false);
        }
        //TODO handle topics
        if (topicId == 0) {
